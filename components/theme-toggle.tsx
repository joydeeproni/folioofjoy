...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed bottom-[calc(1.5rem+var(--sab))] left-[calc(1.5rem+var(--sal))] z-50 flex items-center gap-2 px-3 py-2 rounded-full backdrop-blur-xl border border-white/10 shadow-2xl transition-all duration-300 hover:bg-white/5"
