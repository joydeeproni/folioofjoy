...
export const LOCAL_WORK: WorkItem[] = [
  ...
  { src: `${BLOB}/property-dashboard-01.png`, caption: "Cassi — a property dashboard for juggling more than one home: messages, assets, work orders, calendar.", category: 'SVC', links: CASSI },
